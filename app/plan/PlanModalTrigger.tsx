  ...
  return (
    ...
    >
      ...
      <h3 className="mt-2 font-display text-[24px] sm:text-[28px] leading-tight text-[var(--ink)] max-w-[420px]">
        ...
        <span className="text-[var(--ink-soft)]">venster.</span>
      </h3>
      ...
      <button
        type="button"
        {...calPopupAttrs}
        className="mt-7 inline-flex items-center gap-2 px-5 py-2.5 rounded-[10px] text-[14px] bg-[var(--terra)] text-[var(--paper)] hover:bg-[var(--oker-deep)] transition-colors lift-on-hover"
      >
        Open de kalender
