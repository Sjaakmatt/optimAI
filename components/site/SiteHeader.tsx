        ...
        <div className="band pt-3 sm:pt-4">
          ...
          >
            <Link href="/" className="flex items-center gap-2 pl-1 min-w-0" aria-label="FactumAI, naar de homepage">
              <Image src="/branding/factumai/logo-transparent.webp" alt="FactumAI" width={1107} height={234} priority className="h-auto w-[130px] sm:w-[148px] shrink-0 rounded-none" />
            </Link>
